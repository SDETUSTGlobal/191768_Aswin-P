...
driver.find_element_by_id("name").send_keys("Aswin P")
time.sleep(2)

#identify the Employee id text box and enter the value
driver.find_element_by_id("eid").send_keys("191768")
time.sleep(1)
...
driver.find_element_by_id("eml").send_keys("191768@ust.com")

#Click on submit button
driver.find_element_by_xpath("/html/body/div/form/div[5]/input").click()
time.sleep(5)
